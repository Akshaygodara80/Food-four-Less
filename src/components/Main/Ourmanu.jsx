          ...
          {Card2.map((items, index) => (
            ...
            >
              ...
              <div className=" mt-4 px-4 pb-4">
                ...
                <p className="  text-start text-[12px] font-inter sm:text-[16px] font-normal text-black opacity-[0.7] leading-[129.023%] capitalize mt-4">
                  {items.parathis}
                </p>
